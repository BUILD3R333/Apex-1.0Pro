--[[ Apex Lite ]] return(function()
    ...
    commandsContent.CanvasSize = UDim2.new(0, 0, 0, 450)
    ...
    designContent.CanvasSize = UDim2.new(0, 0, 0, 200)
    ...
    local function updateESP()
        ...
        for _, plr in pairs(game.Players:GetPlayers()) do
            if plr ~= player then
                ...
                -- Проверка на убийцу (руки + рюкзак)
                ...
                -- Проверка на шерифа (руки + рюкзак)
                local hasGun = false
                if plrChar then
