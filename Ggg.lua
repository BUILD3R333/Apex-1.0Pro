-- =====================================================
-- SPEED ONLY (С РЕГУЛИРОВКОЙ +5 / -5)
-- Без лишних функций, только скорость
-- =====================================================
...
-- Кнопка "Умереть" (для активации бага, если нужна)
...
print("✅ SPEED ONLY загружен! +5 / -5, без лишних функций.")
